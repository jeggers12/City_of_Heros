...
public class CityofHeros {
    ...
    public static void main(String[] args) {
     ...
     // char in = mainView.getInput();
        // CityofHeros.output.println("YOU ENTERED " + in);
        // showHelp Help = new showHelp();
        //* if(in == 'H'){
        //      char opt = Help.opt();
        //  CityofHeros.output.println("YOU ENTERED " + opt);
        ...
        // CityofHeros.output.println("You Entered " + exit);
        //  Map map = new Map();
        //  map.initialize();
        //CityofHeros.output.println(map.toString());
    }
